                    ...
                    <form className="" onSubmit={handleSubmit(SubmitData)}>
                      ...
                      <div className="flex items-center justify-between mt-4">
                        ...
                        <Link
                          href="/login"
                          type="button"
                          className="inline-block rounded-2xl border-2 border-danger px-6 pb-[6px] pt-2 text-xs font-medium uppercase leading-normal text-danger transition duration-150 ease-in-out hover:border-danger-600 hover:bg-danger-50/50 hover:text-danger-600 focus:border-danger-600 focus:bg-danger-50/50 focus:text-danger-600 focus:outline-none focus:ring-0 active:border-danger-700 active:text-danger-700 bg-black text-white"
